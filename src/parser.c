...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_number_token3] = ACTIONS(7),
    [aux_sym_number_token4] = ACTIONS(7),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [22] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(2),
  ...
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number, 1),
  [46] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_number, 1),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  [50] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 2),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unquote, 2),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unquote, 2),
  ...
  [62] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_node, 3),
  ...
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(14),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [83] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(14),
