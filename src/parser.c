  ...
  switch (state) {
    ...
    case 3:
      ...
      if (lookahead == '"' ||
          ...
          lookahead == 'n' ||
          lookahead == 'r' ||
          ('t' <= lookahead && lookahead <= 'v')) ADVANCE(36);
      END_STATE();
    case 4:
    ...
    case 20:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == ' ') SKIP(20)
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(30);
      if (sym_symbol_character_set_2(lookahead)) ADVANCE(25);
      END_STATE();
    case 21:
    ...
    case 23:
      ...
      if (sym_symbol_character_set_3(lookahead)) ADVANCE(25);
      END_STATE();
    case 24:
      ACCEPT_TOKEN(sym_symbol);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [83] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(14),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [88] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(14),
