...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (sym_symbol_character_set_1(lookahead)) ADVANCE(44);
      END_STATE();
    case 1:
      if (lookahead == '\n') SKIP(2)
      if (lookahead == '"') ADVANCE(48);
    ...
    case 20:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == ' ') SKIP(20)
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(32);
      if (sym_symbol_character_set_2(lookahead)) ADVANCE(44);
      END_STATE();
    case 21:
    ...
    case 24:
      ...
      if (sym_symbol_character_set_3(lookahead)) ADVANCE(44);
      END_STATE();
    case 25:
    ...
    case 26:
      ...
      if (sym_symbol_character_set_4(lookahead)) ADVANCE(44);
      END_STATE();
    case 27:
    ...
    case 38:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(36);
      if (sym_symbol_character_set_5(lookahead)) ADVANCE(44);
      END_STATE();
    case 39:
      ACCEPT_TOKEN(sym_symbol);
      if (lookahead == '0' ||
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    ...
    [sym_comment] = ACTIONS(3),
    [aux_sym_number_token1] = ACTIONS(24),
    [aux_sym_number_token2] = ACTIONS(24),
    [aux_sym_number_token3] = ACTIONS(24),
    [aux_sym_number_token4] = ACTIONS(24),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [24] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(7),
  ...
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_number, 1),
  ...
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unquote, 2),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unquote, 2),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_node, 3),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_node, 3),
  ...
  [87] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(15),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(15),
...
extern const TSLanguage *tree_sitter_scratchlisp(void) {
